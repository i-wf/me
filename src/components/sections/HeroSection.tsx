...
const socials = [
  ...
  { name: "Fiverr", href: "#", icon: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M23.004 15.588a.995.995 0 1 0 .002-1.99.995.995 0 0 0-.002 1.99zm-.996-3.705h-.85c-.546 0-.846.388-.846.845v2.86h1.696v-2.86c0-.457-.3-.845-.846-.845h-.85zm-4.035-1.423c-.547 0-.99.444-.99.99s.443.99.99.99.99-.444.99-.99-.443-.99-.99-.99zm.99 3.423h-1.98v3.564h1.98v-3.564zm-5.996-1.423c-.547 0-.99.444-.99.99s.443.99.99.99.99-.444.99-.99-.443-.99-.99-.99zm.99 3.423h-1.98v3.564h1.98v-3.564zM7.98 10.46c-.547 0-.99.444-.99.99s.443.99.99.99.99-.444.99-.99-.443-.99-.99-.99zm.99 3.423H6.99v3.564h1.98v-3.564zm-5.986-1.423c-.547 0-.99.444-.99.99s.443.99.99.99.99-.444.99-.99-.443-.99-.99-.99zm.99 3.423H1.994v3.564h1.98v-3.564zM1 18.452h22v1H1z"/></svg>
  )},
  { name: "Freelancer", href: "#", icon: (
    <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M14.096 3.076l1.634 2.292L24 3.076H14.096zM8.862 3.076L0 7.376l2.066 2.596 5.18-2.452-1.496 7.602 2.882 2.674 2.536-10.818 3.12-1.144-1.574-2.758H8.862z"/></svg>
  )},
];
...
const HeroSection = () => (
  <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 pt-24">
    <div className="relative z-10 w-full max-w-6xl mx-auto">
      ...
      {/* About Me mini section with socials */}
      <motion.div
      ...
      >
        ...
        {/* Socials row */}
        <div className="flex flex-wrap items-center justify-center gap-2 mt-5 pt-5 border-t border-border/20">
          {socials.map((social) => (
            <a
              key={social.name}
              href={social.href}
              ...
              className="p-2.5 rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary/50 transition-all duration-300"
              title={social.name}
            >
              {social.icon}
            </a>
